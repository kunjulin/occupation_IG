Profile: OHECompositionServiceRecordProfile
Parent: Composition
Id: OHE-Composition-ServiceRecord
Title: "勞工健康服務執行紀錄組成結構 Profile"
...
* section[workplace].entry only Reference(OHEEncounterServiceProfile)
