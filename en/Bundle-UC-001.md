# UC-001 一般健康檢查報告封包 - 臺灣健康檢查資料交換實作指引 (Taiwan Health Assessment Implementation Guide, TWHA IG) v0.1.0

## Example Bundle: UC-001 一般健康檢查報告封包
...
```json
{
  ...
  "entry" : [{
    "fullUrl" : "https://twcore.mohw.gov.tw/ig/twha/Composition/composition-uc001",
    "resource" : {
