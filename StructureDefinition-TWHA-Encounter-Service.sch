...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'https://twcore.mohw.gov.tw/ig/twha/StructureDefinition/ext-employer-info']) &gt;= 1">extension with URL = 'https://twcore.mohw.gov.tw/ig/twha/StructureDefinition/ext-employer-info': minimum cardinality of 'extension' is 1</sch:assert>
